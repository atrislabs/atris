...
function classify(ref, file) {
  ...
  return { status: 'moved', line: candidates[0] };
}
...
function newRefText(ref) {
  const width = ref.end ? ref.end - ref.start : null;
  const lineText = width === null ? `${ref.line}` : `${ref.line}-${ref.line + width}`;
...
module.exports = { checkMapRefs, fixMapRefs };
