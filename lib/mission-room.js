...
function defaultThinkingBody() {
  return [
    ...
    '',
    'This file says how the operator thinks.',
    '',
    ...
    '- The operator keeps taste, judgment, priority, budget, customer calls, and final accept.',
...
function writeThinkingMemory(room, options = {}) {
  ...
  return {
    ...
    purpose: 'how the operator thinks, decides, approves, rejects, prioritizes, and explains.',
  };
}
