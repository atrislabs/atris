...
const WIKI_SUBDIRS = ['people', 'systems', 'concepts', 'syntheses'];
...
- \`${WIKI_ROOT}/syntheses/\` - multi-page answers and cross-cutting analysis
...
- ${WIKI_ROOT}/syntheses/ - cross-cutting analyses referencing 3+ pages

Page format:
---
type: person | system | concept | synthesis
slug: short-id
...
If the answer reveals a reusable insight, offer to save it as a synthesis page.`;
}
