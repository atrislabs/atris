 ...
 */
// Blocked means a task whose status is failed (the board renders those under
// "## Blocked"). The task DB is the source of truth; without one, only the
// Blocked section of TODO.md counts, never a word elsewhere in a title.
