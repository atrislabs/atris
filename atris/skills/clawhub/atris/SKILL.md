---
name: atris
description: Structured codebase intelligence. Generates a navigation map with exact file:line references so you stop re-scanning the same files every session. Scan once, reference forever.
version: 1.0.0
requires:
  bins:
    - rg
