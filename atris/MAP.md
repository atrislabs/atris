...
rg "worktreeCommand|startWorktree|shipWorktree|cleanupWorktrees|pruneGeneratedWorktreeCaches|parseWorktrees|swarloClaim" commands/worktree.js  # Member-scoped isolated Git worktrees with cleanup-before-create, live-process protection, retained branches, ignored build-cache pruning, optional Swarlo claim, and guarded ship flow
