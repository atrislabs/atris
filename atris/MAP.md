...
- Human CLI timeline proof stays in mission history instead of exposing receipt paths; current budget work overrides premature receipt actions and hides stale historical completion commands; ordinary historical next steps are labeled `at the time`; JSON retains exact paths.
