...
rg "youtubeCommand|processYoutube|runYoutubeNotes|Usage: atris youtube|process_youtube|ytnotes" commands/youtube.js bin/atris.js test/youtube.test.js scripts/det/ytnotes atris/skills/youtube/SKILL.md  # YouTube CLI: `commands/youtube.js:447` notes wraps bundled `scripts/det/ytnotes`; `commands/youtube.js:465` routes `atris youtube notes <url> [engine]`; `bin/atris.js:572` help lists notes vs process; `test/youtube.test.js:242` covers missing-url and non-youtube exit 2. Process remains the 5-credit cloud knowledge path.
...
- **atris youtube notes:** `commands/youtube.js:447` runs the bundled `scripts/det/ytnotes` rail with inherited stdio; `commands/youtube.js:26` lists notes next to process; `bin/atris.js:572` names the help line; `test/youtube.test.js:242` and `test/youtube.test.js:253` cover usage and non-youtube exit 2.
