...
rg "result_base64|buildToolResultBody|encodeToolResult" commands/probe.js commands/workflow.js lib/tool-result-encode.js test/tool-result-encode.test.js # Tool-result relay encoding: base64-wrap hostile-looking shell output before the Cloudflare boundary
