...
rg "renderCard|renderPageSection|renderEmailLine|renderMorningCardRow|directProofText|todayMissionReceiptLines" lib/receipt-block.js commands/now.js commands/mission.js test/receipt-block.test.js # Receipt block: existing mission receipt schema gains optional render surfaces, now.md shows complete mission rows without ellipsis fragments, and first-person check process becomes a direct passed fact
