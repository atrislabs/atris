...
rg "isNonInteractive|isForcedNonInteractive|ATRIS_NONINTERACTIVE|refuseHeadlessUnless|isHelpToken|argsWantHelp|rejectUnsupportedJson|whoami --json|PROMPT ONLY|ACTION TAKEN|seedInitTaskPlane|importJournalFile|join --help|signup help|avail --help|helpOnly|write start help|showStartHelp|start --help" lib/noninteractive.js lib/workspace-scaffold.js commands/auth.js commands/log.js commands/now.js commands/skill.js commands/member.js commands/version.js commands/workflow.js commands/wiki.js commands/task.js commands/social.js commands/signup.js commands/avail.js commands/spaceship.js commands/dream.js commands/scout.js commands/interview.js commands/autopilot-front.js commands/write.js bin/atris.js test/dogfood-p0.test.js test/dogfood-p0-safety.test.js test/signup.test.js test/write.test.js test/dogfood-pass4.test.js  # Dogfood P0 + pass-4 safety: help on start/voice words is usage before NL; noninteractive guard; help-before-network; headless autopilot --json status; JSON contracts
rg "voiceTriggers|Unknown command|Did you mean|SINGLE_WORD_NATURAL_INTENTS|unknownCommandToken|isFlagLikeAnswer" bin/atris.js lib/context-gatherer.js test/dogfood-p0-safety.test.js test/dogfood-pass4.test.js  # One-word start/go/audit/deploy no longer voice-spawn runners; unmatched first tokens (`taks list`) exit 2 even with extra args; start --help is usage; flag titles never become tasks
...
=======
>>>>>>> d92ebf0c (fix: drop leftover MAP conflict markers after rebase)
...
rg "requireAccountBound|account-global|isBoundBusinessWorkspace|--account|Pass --yes to create a live business|Pass --yes to publish" lib/account-bound.js bin/atris.js commands/business.js commands/terminal.js commands/fleet-report.js commands/site-deploy.js commands/chat-scan.js test/dogfood-pass2-t1-t5.test.js test/dogfood-pass4.test.js  # Unbound folders refuse business/rainmaker/avail/feedback/agent/terminal/fleet-report/site deploy unless --account; business ship and site deploy also need --yes; terminal/fleet-report parse --help/--json before slug
