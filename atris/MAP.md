...
- **Routing:** `bin/atris.js:2737` (`command === 'gmail'`) and `bin/atris.js:2775` (`command === 'slack'`): always `requireAccountBound`; a refused gmail gate returns before `gmailCommand` so connect cannot fall through to exit 0; `--help` still prints usage
...
- **Gmail regressions:** `test/gmail-account.test.js:99` (connect validation), `test/gmail-account.test.js:129` (poll success), `test/gmail-account.test.js:182` (timeout), `test/gmail-account.test.js:298` (inbox mailbox header), `test/gmail-account.test.js:386` (send request), `test/gmail-account.test.js:436` (unowned send refusal), `test/gmail-account.test.js:471` (send usage), `test/gmail-account.test.js:501` (voice clear), `test/gmail-account.test.js:531` (piped voice), `test/gmail-account.test.js:564` (account roster), `test/gmail-account.test.js:610` (interactive display-name picker), `test/dogfood-pass3-27-28.test.js` (unbound scratch `gmail connect` exits 2 with no network or connect flow)
