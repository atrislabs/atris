...
- **Core functions:** `commands/experiments.js:55` (`ensureExperimentsFramework`), `commands/experiments.js:141` (`parseMeasureScore`), `commands/experiments.js:154` (`runMeasureJson`), `commands/experiments.js:182` (`experimentsKeep`), `commands/experiments.js:233` (`runResetScript`), `commands/experiments.js:264` (`experimentsRevert`), `commands/experiments.js:481` (`buildBenchmarkArtifact`), `commands/experiments.js:592` (`experimentsRun`), `commands/experiments.js:654` (`experimentsCompare`), `commands/experiments.js:686` (`experimentsReplay`)
- **Daily loop:** `commands/experiments.js:708` (`experimentsDaily`), `commands/experiments.js:714` (`experimentsQueue`), `commands/experiments.js:727` (`experimentsCommand` routes `daily`, `queue`, `keep`, and `revert`)
...
- **Commands:**
- `atris gmail inbox [--account <id>]` (`commands/integrations.js:302`, `gmailInbox`): lists messages and names the resolved mailbox when its email is known
- `atris gmail triage [--account <id>] [--limit N]` (`commands/integrations.js:402`, `gmailTriage`): reads recent inbox messages, applies deterministic broadcast rules, and records keep or archive verdicts without changing the mailbox
...
- Gmail dispatch and help live in `commands/integrations.js:782` (`gmailCommand`); unbound scratch folders refuse bare `atris gmail` via `requireAccountBound` before this runs
...
**Search:** `rg "gmailInbox|gmailTriage|gmailTriageVerdict|gmailSend|gmailVoice|gmailConnect|gmailAccounts|gmailUse|gmailCommand|calendarCommand|twitterCommand|slackCommand|integrationsStatus|showIntegrationsHelp|integrations --help|--approved|requireAccountBound" bin/atris.js commands/integrations.js lib/account-bound.js test/gmail-triage.test.js test/gmail-account.test.js test/commands.test.js test/dogfood-pass3-27-28.test.js`
