...
rg "missionVerifierCheckedText|missionVerifierHighLevelTestText|test -s|land status" commands/mission.js test/mission-status.test.js # Human verifier proof: new and historical non-empty-file and landing-status checks render as artifact/queue facts without shell syntax or private absolute paths
