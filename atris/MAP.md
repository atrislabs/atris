...
rg "missionDrive|destinationHash|mission_destination_change_proposed|pending_destination_proposal" commands/mission.js test/mission-status.test.js test/self-driving-mission.test.js  # Self-driving mission Step 1: optional destination trip contract, status JSON round-trip, and operator-gated destination change proposals
