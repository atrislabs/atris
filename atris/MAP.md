...
rg "isNonInteractive|isForcedNonInteractive|ATRIS_NONINTERACTIVE|refuseHeadlessUnless|isHelpToken|argsWantHelp|rejectUnsupportedJson|whoami --json|PROMPT ONLY|ACTION TAKEN|seedInitTaskPlane|importJournalFile|join --help|signup help" lib/noninteractive.js lib/workspace-scaffold.js commands/auth.js commands/log.js commands/now.js commands/skill.js commands/member.js commands/version.js commands/workflow.js commands/wiki.js commands/task.js commands/social.js commands/signup.js commands/spaceship.js commands/dream.js commands/scout.js commands/interview.js test/dogfood-p0.test.js test/dogfood-p0-safety.test.js test/signup.test.js  # Dogfood P0 + pass-3 safety: noninteractive guard, help-before-network for join/friends/inbox/signup, headless runner refuse, JSON contracts
rg "voiceTriggers|Unknown command|Did you mean|SINGLE_WORD_NATURAL_INTENTS" bin/atris.js test/dogfood-p0-safety.test.js  # One-word start/go/audit/deploy no longer voice-spawn runners; unmatched single verbs exit 2
...
rg "compactErrorPayload|printCliJson|wantsFull|cli-json" lib/cli-json.js commands/task.js commands/mission.js test/dogfood-pass2.test.js  # Compact --json errors/success for current-step/tick/ready; --full dumps
...
<<<<<<< HEAD
rg "youtubeCommand|processYoutube|runYoutubeNotes|parseNotesArgs|runYoutubeNotesBatch|fileBriefFromNotes|runYoutubeDigest|collectVideoBriefs|tickWatch|watch add|Usage: atris youtube|process_youtube|ytnotes" commands/youtube.js bin/atris.js test/youtube.test.js test/youtube-batch.test.js test/youtube-watch.test.js test/youtube-digest.test.js scripts/det/ytnotes atris/skills/youtube/SKILL.md  # YouTube CLI: notes/digest/watch/process
=======
rg "youtubeCommand|processYoutube|runYoutubeNotes|parseNotesArgs|runYoutubeNotesBatch|fileBriefFromNotes|runYoutubeDigest|collectVideoBriefs|tickWatch|watch add|Usage: atris youtube|process_youtube|ytnotes" commands/youtube.js bin/atris.js test/youtube.test.js test/youtube-batch.test.js test/youtube-watch.test.js test/youtube-digest.test.js scripts/det/ytnotes atris/skills/youtube/SKILL.md  # YouTube CLI: `commands/youtube.js:28` help lists notes (one url, several urls, or a playlist), process, digest, and watch add/list/remove/tick; `commands/youtube.js:482` parseNotesArgs keeps the engine as the one non-url trailing word; `commands/youtube.js:513` files a wiki brief after notes exit 0; `commands/youtube.js:585` parses digest --days (default 7); `commands/youtube.js:615` collects video briefs in the date window and skips digest- plus non-http sources; `commands/youtube.js:699` writes atris/wiki/briefs/digest-YYYY-MM-DD.md and a claimable journal line; `commands/youtube.js:894` watch add writes `{channel, added}` to `.atris/state/youtube_watch.json`; `commands/youtube.js:956` tick fetches three latest ids, seeds a fresh channel, and briefs unseen via ytnotes; `commands/youtube.js:1184` notes batch expands playlists (cap 10), runs urls sequentially, and prints a per-video summary; `commands/youtube.js:1211` notes wraps bundled `scripts/det/ytnotes`; `commands/youtube.js:1229` routes notes, digest, and watch before process; `bin/atris.js:575` help lists notes, digest, and process; `test/youtube.test.js:246` covers missing-url and non-youtube exit 2; `test/youtube.test.js:265` covers brief + journal filing; `test/youtube-batch.test.js:1` covers multi-url sequencing, playlist cap 10, continue-on-fail, all-fail exit 2, and unchanged single-url notes; `test/youtube-watch.test.js:1` covers add/list/remove, unseen-only briefs, fresh-channel newest-only seed, and failed-fetch skip; `test/youtube-digest.test.js:1` covers window filtering, digest- and non-video skips, filed sources, journal append, and empty-window no-op. Process remains the 5-credit cloud knowledge path.
rg "xSearchCommand|parseXSearchArgs|runXSearch|formatXSearchResult|/x-search/search|research-person|Usage: atris x-search" commands/x-search.js bin/atris.js lib/known-commands.js test/x-search.test.js atris/skills/x-search/SKILL.md  # X search CLI: `commands/x-search.js` mirrors youtube process auth via ensureValidCredentials + apiRequestJson; search posts `/x-search/search` with `{query, limit?, days_back?}`; person posts `/x-search/research-person`; help/print/401/402 covered in `test/x-search.test.js` with mocked apiRequestJson (no live credits); `bin/atris.js` help + dispatch next to youtube; skill documents `atris x-search` as the customer path.
>>>>>>> b6de5e6a (feat(cli): add atris x-search for billed X/Twitter pulls)
...
rg "requireAccountBound|account-global|isBoundBusinessWorkspace|--account" lib/account-bound.js bin/atris.js test/dogfood-pass2-t1-t5.test.js  # Unbound folders refuse business/rainmaker/avail/feedback/agent unless --account
...
rg "workspace-free help smoke|showSearchHelp|showLearnHelp|showSoulHelp|showHelpShort|help --all|help --json" bin/atris.js commands/learn.js commands/soul.js test/commands.test.js test/golden-path-help.test.js test/dogfood-papercuts.test.js  # Help surfaces: short golden path, --all, --json, workspace-free help smoke
...
rg "requireAccountBound|refuseAccountGlobal|ACCOUNT_GLOBAL_MESSAGE|isBoundBusinessWorkspace|join --help|friends --help|inbox --help|signup help" lib/account-bound.js bin/atris.js commands/social.js commands/signup.js test/dogfood-pass3-27-28.test.js test/dogfood-p0-safety.test.js test/signup.test.js # Unbound folders refuse account-global inbox/gmail/slack/errors; join/friends/inbox/signup help prints usage and does not hit the network
- Help-before-network: `commands/social.js:173` friends, `commands/social.js:391` join, `commands/social.js:571` friendsCommand, `commands/social.js:581` inboxCommand, `commands/signup.js:53` signup help. Regression: `test/dogfood-p0-safety.test.js` (`29:`) and `test/signup.test.js`.
