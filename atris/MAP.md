...
rg "isNonInteractive|isForcedNonInteractive|ATRIS_NONINTERACTIVE|rejectUnsupportedJson|whoami --json|PROMPT ONLY|ACTION TAKEN|seedInitTaskPlane|importJournalFile" lib/noninteractive.js lib/workspace-scaffold.js commands/auth.js commands/log.js commands/now.js commands/skill.js commands/member.js commands/version.js commands/workflow.js commands/wiki.js commands/task.js test/dogfood-p0.test.js  # Dogfood P0: noninteractive guard, JSON contracts, init task plane, prompt/action labels
