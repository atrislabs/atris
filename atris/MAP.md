...
rg "youtubeCommand|processYoutube|runYoutubeNotes|parseNotesArgs|runYoutubeNotesBatch|fileBriefFromNotes|runYoutubeDigest|collectVideoBriefs|tickWatch|watch add|parseSearchArgs|parseSearchStdout|runPaidYoutubeSearch|/youtube/search|--paid|Usage: atris youtube|process_youtube|ytnotes|ytsearch" commands/youtube.js bin/atris.js test/youtube.test.js test/youtube-batch.test.js test/youtube-watch.test.js test/youtube-digest.test.js test/youtube-search.test.js test/billed-command-auth.test.js scripts/det/ytnotes scripts/det/ytsearch atris/skills/youtube/SKILL.md  # YouTube CLI: `commands/youtube.js:26` help lists search (free), search --paid (5-credit watch permalinks), notes, process, digest, and watch; `commands/youtube.js:1290` parseSearchArgs accepts --paid; `commands/youtube.js:1484` runPaidYoutubeSearch posts /youtube/search via ensureBilledCommandAuth (scope youtube), mints/retries like x-search, never /auth/cli; `commands/youtube.js:1551` free runYoutubeSearch still prefers PATH ytsearch, then bundled `scripts/det/ytsearch`, then yt-dlp ytsearchN; `commands/youtube.js:1616` routes search before notes/digest/watch/process; `bin/atris.js` --all help names paid search; `test/youtube-search.test.js` mocks runner and HTTP (no live credits); process remains the 5-credit cloud knowledge path.
