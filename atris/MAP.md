...
- **Search:** `rg "shouldGatherContext|saveContextProfile|createStarterTask|buildFirstMinute|freshMinuteJson|speakFirstMinute|printWishReceptionist|cmdFirstMinute|isUninitializedTaskFolder|deskNextCommand|taskNextCommand|cmdNext|cmdNextTruth|Context gatherer" bin/atris.js lib/context-gatherer.js lib/first-minute.js commands/task.js commands/workflow.js commands/wish.js commands/human-missions.js commands/mission.js test
