...
rg "runCloudWish|cloudWishOptionError|--cloud|findActiveWishFlight|attached_to_existing_flight" commands/wish.js lib/cloud-mission.js lib/wish-delegate.js test/wish-cloud.test.js test/wish.test.js  # Wish dispatch: enqueue cloud wishes, persist cloud receipts, and attach duplicate local slices to an existing active flight
...
- **Execution boundary:** `lib/fleet.js:518-718` combines credential stripping, command guards, native engine sandboxes, and a fail-closed macOS filesystem profile; `lib/fleet.js:788-947` creates a bundle-seeded temp worktree whose only remote is a local quarantine and compares every quarantine/protected ref.
