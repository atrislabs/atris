...
rg "initAtris|upsertAtrisClaudeBootBlock|upsertClaudeVoiceHook|upsertCursorVoiceCard|upsertAgentVoiceCard" commands/init.js lib/claude-boot-block.js lib/voice-card.js test/claude-boot-block.test.js test/voice-card.test.js  # Init command, hook-aware root CLAUDE.md boot block, and non-destructive Claude/Cursor/AGENTS voice-card doors
