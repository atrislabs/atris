...
rg "cmdAdd|cmdRetitle|cmdImport|cmdClaim|cmdReady|cmdAccept|cmdSweep|cmdClearDone|cmdAudit|cmdReviews|cmdDone|cmdNext|readEndgameAgentAction|liveTaskWithTitle|getTaskDb|task accept --help|task claim --help|task ready --help|task step --help" commands/task.js test/task-retitle.test.js test/task-sweep-auto-accept.test.js test/task-clear-done.test.js test/task-audit.test.js test/task-accept-help.test.js test/task-claim-help.test.js test/task-ready-help.test.js test/task-step-help.test.js  # Local agent task plane, title history, proof-ready review, human accept, accept/claim/ready/step --help usage locks, low-stakes auto-accept sweep, completed-task cleanup, accepted-proof audit, task-next Endgame seed dedupe, and compact certified review queue
