...
rg "caretakerCommand|classifyPullRequest|caretaker.scan.latest|command === 'caretaker'" commands/caretaker.js bin/atris.js lib/known-commands.js test/caretaker-scan.test.js  # PR caretaker scan: `commands/caretaker.js:135` classifies open PRs via gh into ci-red/changes-requested/green-mergeable/waiting, `commands/caretaker.js:213` writes `.atris/state/caretaker.scan.latest.json`, `commands/caretaker.js:237` is the command entry, `bin/atris.js:1913` routes it, `bin/atris.js:563` lists help, `lib/known-commands.js:6` registers the name, and `test/caretaker-scan.test.js:1` stubs gh on PATH for the four states plus receipt shape.
