...
| roster file and routing | `lib/engine-registry.js:815`, `lib/engine-registry.js:837`, `lib/engine-registry.js:724`, `lib/engine-registry.js:872`, `lib/engine-registry.js:950`, `lib/engine-registry.js:1028`, `lib/engine-registry.js:1071` | picks live in `atris/ROSTER.md` (this project) and `~/.atris/ROSTER.md` (all projects), hand-editable; bad lines become warnings; assign edits one line; with no ROSTER.md the older JSON picks still route, and the first assign copies them in; project pick, backup, all-projects pick, backup, then the job's kind, then the router |
| roster words, job names, and dates | `lib/engine-registry.js:607`, `lib/engine-registry.js:644`, `lib/engine-registry.js:308`, `lib/engine-registry.js:575`, `lib/engine-registry.js:449` | engine or model words to one engine and model; names that only look like a built-in job are refused; `until oct 24` counts from when the file was written |
...
| team members pick engines | `lib/member-engine.js:77`, `lib/member-engine.js:119`, `lib/member-engine.js:179`, `commands/mission.js:388`, `commands/member.js:868`, `commands/autopilot.js:508` | search, review, or build from name or role, `## team` overrides; owned missions, `member run`, and autopilot phases use the pick; `--engine` still wins |
| roster commands and view | `commands/engine.js:1026`, `commands/engine.js:1040`, `commands/engine.js:1102`, `commands/engine.js:1115`, `commands/engine.js:1300` | view with the file each pick came from, team block, warnings, confirm, assign, clear, and `resolve <job>` |
| roster model reaches runs | `lib/engine-registry.js:1119`, `commands/mission.js:388`, `commands/one-lap.js:206`, `lib/fleet.js:2812`, `lib/runner-command.js:182` | carries the pinned model into missions, one-lap builds and reviews, and fleet spawns; devin and grok get `--model` only when pinned |
| small build pick | `lib/engine-registry.js:1049`, `lib/wish-audit.js:436` | a low-stakes build or the job option checks the "small build" pick first; quick wishes ask for it |
