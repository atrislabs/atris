...
rg "isNonInteractive|isForcedNonInteractive|ATRIS_NONINTERACTIVE|refuseHeadlessUnless|isHelpToken|argsWantHelp|rejectUnsupportedJson|whoami --json|PROMPT ONLY|ACTION TAKEN|seedInitTaskPlane|importJournalFile" lib/noninteractive.js lib/workspace-scaffold.js commands/auth.js commands/log.js commands/now.js commands/skill.js commands/member.js commands/version.js commands/workflow.js commands/wiki.js commands/task.js commands/social.js commands/spaceship.js commands/dream.js commands/scout.js commands/interview.js test/dogfood-p0.test.js test/dogfood-p0-safety.test.js  # Dogfood P0 + pass-3 safety: noninteractive guard, help-before-network, headless runner refuse, JSON contracts
