...
- `lib/engine-ask.js:82`, `lib/engine-ask.js:160`, `lib/engine-ask.js:221`, `lib/engine-ask.js:310`, `lib/engine-ask.js:358`, `lib/engine-ask.js:397` - parallel read-only engine questions: shared prompt and per-engine jobs parsing, engine-specific safe command shapes, capped output and process-group timeouts, bounded concurrency, labeled receipts under `atris/runs/`, and plain completion summaries; routed at `commands/engine.js:1416`; fake-process regressions cover fan-out, limits, cleanup, silent output, receipts, and no worktree or lock writes in `test/engine-ask.test.js:57`, `test/engine-ask.test.js:137`, `test/engine-ask.test.js:168`, `test/engine-ask.test.js:201`, and `test/engine-ask.test.js:233`.
