...
rg "cmdAdd|cmdImport|cmdClaim|cmdReady|cmdAccept|cmdSweep|cmdAudit|cmdReviews|cmdDone|cmdNext|readEndgameAgentAction|liveTaskWithTitle|getTaskDb" commands/task.js test/task-sweep-auto-accept.test.js test/task-audit.test.js  # Local agent task plane, proof-ready review, human accept, low-stakes auto-accept sweep, accepted-proof audit, task-next Endgame seed dedupe, and compact certified review queue
