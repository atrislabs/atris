...
rg "printUsage|spaceship --help|NO_COLOR|usage()" commands/spaceship.js scripts/spaceship.sh test/dogfood-pass2-t1-t5.test.js  # spaceship --help is short usage; no color off TTY
