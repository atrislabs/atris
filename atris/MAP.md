...
rg "autopilotAtris|describeAutopilotRunnerIdentity|renderHumanTickIntro" commands/autopilot.js test/autopilot-runner-model.test.js test/commands.test.js  # Autopilot command and runner-visible tick intro
