...
rg "ensureNowFile|renderDefaultNow|renderPortfolioNow|currentMissionMoveLine|compactMissionCommand|countOpenWorkItems|countOpenTodoItems|countJournalCompletedReceipts|now --help" bin/atris.js commands/now.js test/now.test.js test/commands.test.js  # now.md front door: local date, complete current-mission clause, compact untruncated next command, projection-backed open work counts, proof receipts, portfolio signals, non-mutating help
