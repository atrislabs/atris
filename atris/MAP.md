...
- **Runner diagnostics:** `commands/autopilot.js` formats non-zero runner failures with captured stdout/stderr for horizon proposal throws and stale-task model-check fallback reasons (regression: `test/autopilot-runner-diagnostics.test.js`)
