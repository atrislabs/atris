...
rg "runOrb|buildOrbContext|collectOrbContext|appendOrbChoice|command === 'orb'" commands/orb.js lib/orb-context.js bin/atris.js lib/known-commands.js test/orb.test.js  # Orb CLI: deterministic workspace suggestions, interactive choices, and detached engine result logs
