...
- **Activation surface:** `commands/activate.js` prints the current 0-shot route plus durable prompt/menu/model/horizon freshness, all-route menu/global/model/horizon prompt commands, and refreshes the ambient latest files
- **Member activation:** `commands/member.js` prints the current 0-shot route plus durable prompt/menu/model/horizon freshness, all-route menu/global/model/horizon prompt commands, and refreshes the ambient latest files when waking a named member
- **Brain activation:** `commands/brain.js` includes the 0-shot route plus durable prompt/menu/model/horizon freshness, all-route menu and horizon prompt commands in `atris brain activate`, and refreshes the ambient latest files
