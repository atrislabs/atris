...
- **Brain activation:** `commands/brain.js` includes the 0-shot route plus owner-gate context, route inventory, horizon/model buckets, first-by-model and first-by-horizon picks, durable prompt/menu/model/horizon freshness, all-route menu and horizon prompt commands in `atris brain activate`, and refreshes the ambient latest files
