...
- Human CLI timeline proof stays in mission history instead of exposing receipt paths; current budget work overrides premature receipt actions; historical next steps are labeled `at the time`; JSON retains exact paths.
