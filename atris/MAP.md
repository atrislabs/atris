...
rg "missionVerifierCheckedText|missionVerifierHighLevelTestText|test -s" commands/mission.js test/mission-status.test.js # Human verifier proof: new and historical non-empty-file checks render as saved-artifact facts without shell syntax or private absolute paths
