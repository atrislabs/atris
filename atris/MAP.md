...
- `stopCommand()` → `commands/human-missions.js` (empty and file-not-yours reuse speakNothingRunning; after do/claim with no live mission, speakKeepWorkingMinute; does not mint or bind)
