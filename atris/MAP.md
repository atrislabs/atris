...
rg "isNonInteractive|isForcedNonInteractive|ATRIS_NONINTERACTIVE|refuseHeadlessUnless|isHelpToken|argsWantHelp|rejectUnsupportedJson|whoami --json|PROMPT ONLY|ACTION TAKEN|seedInitTaskPlane|importJournalFile|join --help|signup help|avail --help|helpOnly|write start help|showStartHelp|start --help|task accept --help|task claim --help|task ready --help|task step --help" lib/noninteractive.js lib/workspace-scaffold.js commands/auth.js commands/log.js commands/now.js commands/skill.js commands/member.js commands/version.js commands/workflow.js commands/wiki.js commands/task.js commands/social.js commands/signup.js commands/avail.js commands/spaceship.js commands/dream.js commands/scout.js commands/interview.js commands/autopilot-front.js commands/write.js bin/atris.js test/dogfood-p0.test.js test/dogfood-p0-safety.test.js test/signup.test.js test/write.test.js test/dogfood-pass4.test.js test/task-accept-help.test.js test/task-claim-help.test.js test/task-ready-help.test.js test/task-step-help.test.js  # Dogfood P0 + pass-4 safety: help on start/voice words is usage before NL; noninteractive guard; help-before-network; headless autopilot --json status; JSON contracts; task accept/claim/ready/step --help is usage only
...
rg "axLogDirs|chat scan|--global|scope: 'workspace'" lib/chat-log-scan.js commands/chat-scan.js test/dogfood-pass4.test.js  # chat scan defaults to ./atris/runs + this workspace; --global reads ~/.atris/runs and unbound folders need --account
...
rg "cmdAdd|cmdRetitle|cmdImport|cmdClaim|cmdReady|cmdAccept|cmdSweep|cmdClearDone|cmdAudit|cmdReviews|cmdDone|cmdNext|renderTaskDesk|deskNextCommand|readEndgameAgentAction|liveTaskWithTitle|getTaskDb|task accept --help|task claim --help|task ready --help|task step --help" commands/task.js lib/first-minute.js test/task-retitle.test.js test/task-sweep-auto-accept.test.js test/task-clear-done.test.js test/task-audit.test.js test/task-accept-help.test.js test/task-claim-help.test.js test/task-ready-help.test.js test/task-step-help.test.js test/task-desk-next.test.js test/first-minute.test.js  # Local agent task plane, title history, proof-ready review, human accept, accept/claim/ready/step --help usage locks, desk next line shares first-minute pick/taskCommand, low-stakes auto-accept sweep, completed-task cleanup, accepted-proof audit, task-next Endgame seed dedupe, and compact certified review queue
...
- **Regression:** `test/first-minute.test.js`, `test/task-desk-next.test.js`, `test/context-gatherer.test.js`, `test/cli-smoke.test.js`
- **Search:** `rg "shouldGatherContext|saveContextProfile|createStarterTask|buildFirstMinute|deskNextCommand|Context gatherer" bin/atris.js lib/context-gatherer.js lib/first-minute.js commands/task.js test`
