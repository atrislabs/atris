...
rg "youtubeCommand|processYoutube|runYoutubeNotes|fileBriefFromNotes|Usage: atris youtube|process_youtube|ytnotes" commands/youtube.js bin/atris.js test/youtube.test.js scripts/det/ytnotes atris/skills/youtube/SKILL.md  # YouTube CLI: `commands/youtube.js:509` notes wraps bundled `scripts/det/ytnotes`; `commands/youtube.js:470` files a wiki brief after notes exit 0; `commands/youtube.js:537` routes `atris youtube notes <url> [engine]`; `bin/atris.js:575` help lists notes vs process; `test/youtube.test.js:246` covers missing-url and non-youtube exit 2; `test/youtube.test.js:265` covers brief + journal filing. Process remains the 5-credit cloud knowledge path.
