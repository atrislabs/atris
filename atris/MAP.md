...
| roster model reaches runs | `lib/engine-registry.js:1136`, `commands/mission.js:388`, `commands/one-lap.js:206`, `lib/fleet.js:2812`, `lib/runner-command.js:182` | carries the pinned model into missions, one-lap builds and reviews, and fleet spawns; devin and grok get `--model` only when pinned |
