...
- **Now front door:** generated `atris/now.md` includes the current 0-shot route, `atris 0-shot --all` menu command, durable menu/prompt file freshness, bucket counts, first command, and horizon handoff hint so agents loading the first context file can inspect all visible lanes before acting
