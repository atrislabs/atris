...
One. Briefs file themselves. Shipped in 3.49.0, proven live.

Two. Watch feeder. Shipped in 3.50.0; mission 79 runs the daily tick, first tick receipt on file.

Three. Engine race. Shipped; first race crowned haiku (73.6s, 6/6 quotes), grok and fast lanes fail honestly and are flagged as open threads.

Four. Weekly digest. Shipped in 3.51.0; first digest read 7 real briefs in 36s and cited its sources.

Five. Batch and playlists. Shipped in 3.52.0; one command takes several links or a playlist, caps at 10, and prints a per-video summary.
