...
|---|------|----------|--------|
| 1 | [feedback](feedback.md) | user pain becomes tracked work | `rg -c '^(open|claimed)\s+' tasks.md >/dev/null` |
| 2 | [quality](quality.md) | changes do not regress trust | `node --test test/loops.test.js` |
