"""Score teach --save on a fixture thin chapter through the live CLI path."""
...
def repo_root() -> Path:
    ...
    guessed = EXPERIMENT_DIR.parents[3]
    if (guessed / "commands" / "youtube.js").exists():
        return guessed
...
def run_probe() -> dict:
    ...
    proc = subprocess.run(
        ...
        capture_output=True,
        text=True,
        env={**os.environ, "ATRIS_REPO_ROOT": root},
    )
