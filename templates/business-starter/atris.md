...
2. Read `atris/TODO.md` for active tasks
...
- **DO:** Execute step-by-step. Update artifacts (TODO.md, MAP.md) as reality changes.
- **REVIEW:** Verify, test, clean up. Delete completed tasks. Append lessons to `atris/policies/LESSONS.md`.
...
- **Delete completed tasks.** Target state: TODO.md = 0 active items.
