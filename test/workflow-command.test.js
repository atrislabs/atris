...
const { appendReviewLearningToJournal, reviewLearningLine, renderReviewMinute } = require('../commands/workflow');
...
test('review journal write keeps a learning under LF Notes', () => {
  const learning = reviewLearningLine('13:44', '37signals has 80 people and uses the omakase model');
